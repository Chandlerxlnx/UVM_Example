...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xc7s25csga324-1Q
}
...
proc create_root_design { parentCell } {
  ...
  set axi_vip_mst [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip axi_vip_mst ]
  set_property -dict [list \
  ...
  set axi_vip_passthrough [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip axi_vip_passthrough ]
  set_property -dict [list \
    CONFIG.HAS_ACLKEN {0} \
    CONFIG.HAS_ARESETN {1} \
  ] $axi_vip_passthrough
  ...
  set axi_vip_slv [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vip axi_vip_slv ]
  set_property -dict [list \
    CONFIG.ADDR_WIDTH {32} \
    CONFIG.DATA_WIDTH {32} \
    CONFIG.HAS_ACLKEN {0} \
